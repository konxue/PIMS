...
if($_POST['submit_1'])
{
    ...
    while($thisrow = mysqli_fetch_array($results))
    {
        ...
        while ($newrow = mysqli_fetch_array($res))
        {
            ...
            echo "<td><center>" . number_format($newrow['Cost'],2) . "</center></td>";
            echo "<td><center>". $newrow['DateofService']."</center></td>";
             echo '<form id="search-form" method="post">';
             echo '<td><center><input type="hidden" name="pk_id" value="'.$newrow['pk'].'"/>
       ...
       $row1=mysqli_fetch_array($result1);
        ...
        {
           echo '<form id="search-form" method="post">';
             echo '<td><center><input type="hidden" name="logid" value="'.$row1['log_id'].'"/>
